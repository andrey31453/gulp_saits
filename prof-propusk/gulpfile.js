...
const index_html = [
	// index
	{
		...
		src: [
			...
			'app/between-section/oplata-posle.html',
			'app/text/steps.html',
			'app/between-section/ceny.html',
			'app/tab-content/*.html',
			'app/text/why.html',
			'app/between-section/documenty.html',
			'app/tab-content__copy/*.html',
			'app/text/history.html',
			'app/form/*.html',
		],
	},
]
